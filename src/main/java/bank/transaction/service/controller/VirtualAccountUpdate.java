...
public class VirtualAccountUpdate {
    private Logger LOG = LoggerFactory.getLogger(VirtualAccountUpdate.class);
    protected String BNI_UPDATE_DEV(String trx_id, String trx_amount, String customer_name, String customer_email, String customer_phone,String datetime_expired, String description ) throws Exception {

        BniEncryptionClass hash = new BniEncryptionClass();
        String URL_BNI_DEV = Common.URL_BNI_DEV;
        String converted = "";
        String type = "updatebilling";
        String client_id = "00629";
        String data = "{\"type\":\""+type+"\",\"client_id\":\""+client_id+"\",\"trx_id\":\""+trx_id+"\",\"trx_amount\":\""+trx_amount+"\",\"customer_name\":\""+customer_name+"\",\"customer_email\":\""+customer_email+"\",\"customer_phone\":\""+customer_phone+"\",\"datetime_expired\":\""+datetime_expired+"\",\"description\":\""+description+"\"}";
        String cid = "00629";
