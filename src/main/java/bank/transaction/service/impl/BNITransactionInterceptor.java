...
@Singleton
public class BNITransactionInterceptor implements ClientHttpRequestInterceptor {
    private String accessToken;
    private String apiKey;
    private String apiSecret;

    public BNITransactionInterceptor(String accessToken, String apiKey, String apiSecret) {
